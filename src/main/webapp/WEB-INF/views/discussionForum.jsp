...
<head>
	...
	<spring:url value="/resources/javascripts/validate_question.js" var="validateQuestionJS" />
	...
	<script src="${validateQuestionJS}"></script>
...
<body>
	<div class="header">	
      <div class="container"> 
        ...
        <div class="panel panel-default" style="background-color:#f0e1f0">
        <div class="panel-heading" style="background-color:#1f161f">
                <h4 class="panel-title" style="text-transform: uppercase;color:#ffffff;font-family:Californian FB;text-align:left"><b>
                    Questions Posted</b>
                </h4>
            </div>
        <c:forEach items="${questions}" var="questionList">
        	<c:set var="id" value="${questionList.qno}"></c:set>
        	<c:set var="href">#${id}</c:set>
        	<c:set var="answershref">answers.do?qno=${questionList.qno}</c:set>
        	         <div class="panel-heading">
                <h4 class="panel-title">
        	<a href="${answershref}" style="color: black; font-size: medium;">${questionList.description}</a>
        	</h4>
        	</div>
        	  </c:forEach>
        	  <br>
        	  <div class="panel-heading" style="background-color:#1f161f">
                <h4 class="panel-title" style="text-transform: uppercase;color:#ffffff;font-family:Californian FB;text-align:left"><b>
        	  	...
        	  	<form:form name="Addquestion" method="post" onsubmit="return validateQuestion(this);" action="addquestion.do" modelAttribute="questionbean">
			...
			<div class="table-responsive">
				   	...
				   	<tr>
				   	<td><label id="ErrorMessage">${questionErrorMessage}</label><br/></td>
				   	</tr>
				   	<tr>
				   	<td><button class="btn btn-primary" type="submit" id="add" style="background:#1f161f">Post</button></td>
				   	</tr>
				   	</table>
